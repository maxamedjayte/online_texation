...
Partial Class TaxayerIndivitualReort
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If DropDownList1.SelectedIndex = 1 Then
            ...
            sql = "select * from payment where houseno='" & TextBox1.Text & "'"
        ...
        ElseIf DropDownList1.SelectedIndex = 2 Then
            ...
            sql = "select * from payment where Fulname='" & TextBox1.Text & "'"
            da = New SqlDataAdapter(sql, cn)
            ds.Clear()
            da.Fill(ds, "ali")
            rpt.Load(Server.MapPath("paymentCrystalReport.rpt"))
        ...
        ElseIf DropDownList1.SelectedIndex = 3 Then
            ...
            sql = "select * from payment where taxType='" & TextBox1.Text & "'"
            da = New SqlDataAdapter(sql, cn)
            ds.Clear()
            da.Fill(ds, "ali")
            rpt.Load(Server.MapPath("paymentCrystalReport.rpt"))
