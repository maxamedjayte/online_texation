<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Payment.aspx.vb" Inherits="TaxayerIndivitualReort" %>
...
<body>
            ...
            <tr>
                ...
                <td class="style3">
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="27px" Width="350px">
                        ...
                        <asp:ListItem>Fulname</asp:ListItem>
                        <asp:ListItem>Tye of tax</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td>
    ...
    <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" 
        AutoDataBind="True" Height="1027px" Width="929px" />
    </form>
</body>
</html>
