<%@ Page Language="VB" AutoEventWireup="false" CodeFile="IndivitualHouseReport.aspx.vb" Inherits="TaxayerIndivitualReort" %>
...
<body>
            ...
            <tr>
                ...
                <td class="style3">
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="27px" Width="350px">
                        ...
                        <asp:ListItem>housetype</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td>
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="HouseCrystalReport.rpt">
        </Report>
